...
# Form implementation generated from reading ui file './ui/form/SelectWord.ui'
#
...
class Ui_Form_SelectWord(object):
    def setupUi(self, Form_SelectWord):
        ...
        Form_SelectWord.resize(632, 500)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(0, 800, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        ...
        self.groupBox_2.setMinimumSize(QtCore.QSize(370, 85))
        ...
        self.checkBox_SelectWord_Gold.setStyleSheet("QCheckBox::indicator{width :20px;height : 20px;}\n"
"")
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.checkBox_SelectWord_Wood.setFont(font)
        self.checkBox_SelectWord_Wood.setStyleSheet("QCheckBox::indicator{width :20px;height : 20px;}\n"
"")
        self.checkBox_SelectWord_Wood.setChecked(True)
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.checkBox_SelectWord_Water.setFont(font)
        self.checkBox_SelectWord_Water.setStyleSheet("QCheckBox::indicator{width :20px;height : 20px;}\n"
"")
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.checkBox_SelectWord_Fire.setFont(font)
        self.checkBox_SelectWord_Fire.setStyleSheet("QCheckBox::indicator{width :20px;height : 20px;}\n"
"")
        self.checkBox_SelectWord_Fire.setChecked(True)
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.checkBox_SelectWord_Earth.setFont(font)
        self.checkBox_SelectWord_Earth.setStyleSheet("QCheckBox::indicator{width :20px;height : 20px;}\n"
"")
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(200, 85))
