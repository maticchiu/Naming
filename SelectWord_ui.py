...
class Ui_Form_SelectWord(object):
    def setupUi(self, Form_SelectWord):
        ...
        Form_SelectWord.resize(400, 764)
        font = QtGui.QFont()
        ...
        self.listWidget_WordList.setGeometry(QtCore.QRect(10, 190, 131, 561))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_AddWord.setGeometry(QtCore.QRect(160, 250, 71, 51))
        self.pushButton_AddWord.setObjectName("pushButton_AddWord")
        self.pushButton_RemoveWord = QtWidgets.QPushButton(Form_SelectWord)
        self.pushButton_RemoveWord.setGeometry(QtCore.QRect(160, 600, 71, 51))
        ...
        self.listWidget_SelectedWord.setGeometry(QtCore.QRect(250, 190, 131, 561))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 100, 371, 81))
