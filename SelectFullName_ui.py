...
class Ui_Form_SelectFullName(object):
    def setupUi(self, Form_SelectFullName):
        ...
        self.pushButton_AddFullName_2 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.pushButton_AddFullName_2.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_AddFullName_2.setFont(font)
        self.pushButton_AddFullName_2.setObjectName("pushButton_AddFullName_2")
        self.verticalLayout_4.addWidget(self.pushButton_AddFullName_2)
