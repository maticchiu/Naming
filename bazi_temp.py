...
if options.g:
    day = sxtwl.fromSolar(options.year, options.month, options.day)
    # day = lunar.getDayBySolar(options.year, options.month, options.day)
else:
    day = sxtwl.fromLunar(options.year, options.month, options.day, options.r)
    # day = lunar.getDayByLunar(options.year, options.month, options.day, options.r)

gz = sxtwl.getShiGz(day.getDayGZ().tg, int(options.time))

#　计算甲干相合 
Gans = collections.namedtuple("Gans", "year month day time")
gans = Gans(year=Gan[day.getDayGZ().tg], month=Gan[day.getMonthGZ().tg], day=Gan[day.getDayGZ().tg], time=Gan[gz.tg])
Zhis = collections.namedtuple("Zhis", "year month day time")
zhis = Zhis(year=Zhi[day.getDayGZ().dz], month=Zhi[day.getMonthGZ().dz], day=Zhi[day.getDayGZ().dz], time=Zhi[gz.dz])
...
print("农历:")
print("\t{}年{}{}月{}日".format(day.getLunarYear(), Lleap, day.getLunarMonth(), day.getLunarDay()))
